...
public class ResponseData<T> implements Serializable {
    ...
    public boolean isSuccess(){
        return this.status == com.dgut.ssm.common.ResponseCode.SUCCESS.getCode();
    }
    ...
    public static <T> ResponseData<T> success(T data) {
        ...
        return new ResponseData<T>(com.dgut.ssm.common.ResponseCode.SUCCESS.getCode(),data);
    }
    ...
    public static <T> ResponseData<T> success() {
        ...
        return new ResponseData(com.dgut.ssm.common.ResponseCode.SUCCESS.getCode());
    }
    ...
    public static <T> ResponseData<T> fail(int code, String 用户未登陆) {
        return new ResponseData(com.dgut.ssm.common.ResponseCode.ERROR.getCode(), com.dgut.ssm.common.ResponseCode.ERROR.getDesc());
    }

    public static <T> ResponseData<T> fail(String msg){
        return new ResponseData<T>(com.dgut.ssm.common.ResponseCode.ERROR.getCode(),msg);
    }
