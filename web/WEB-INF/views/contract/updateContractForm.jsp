...
<body>
<form:form  class="layui-form" modelAttribute="" action="${requestScope.request.contextPath }/client/updateClient" method="post"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
<div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">销售员联系方式</label>
        <div class="layui-input-inline">
